...
export function TitlePageDesktop({movieData}) {
  return (
    <TitlePageContainer>
      <PageContentContainer>
        <TitlePageDesktopLeft movieData={movieData} />
        <TitlePageDesktopMid movieData={movieData} />
        <TitlePageDesktopRight movieData={movieData} />
      </PageContentContainer>
    </TitlePageContainer>
  );
}
